...
def train(model):
    ...
    train_set = CIFAR10(root="/tmp/data/CIFAR10", train=True, transform=ToTensor(), download=True)
    val_set = CIFAR10(root="/tmp/data/CIFAR10", train=False, transform=ToTensor(), download=False)
